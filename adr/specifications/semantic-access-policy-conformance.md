...
FAI-637 is the partial ATT/control-plane implementation slice, not completion
of this specification. It currently adds the access-owned PostgreSQL
definition registry (revision
...
The repository and contract tests cited here qualify only their linked slices,
