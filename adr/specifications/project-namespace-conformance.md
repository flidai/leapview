...
| BND-01–BND-07 | FAI-666, FAI-669, FAI-671, FAI-675 | [PR #495](https://github.com/flidai/leapview/pull/495), `5d766dc4f`; [PR #512](https://github.com/flidai/leapview/pull/512), `62d039399`; [PR #546](https://github.com/flidai/leapview/pull/546), `4435ea6c1`; [PR #549](https://github.com/flidai/leapview/pull/549), `372039da7` | Generated authoring schema, deterministic unbound compilation, exact delivery binding, selector/cache partitions, and closed graph tests | Partial — BND-06 inventory remains non-exhaustive |
...
| API-01–API-07 | FAI-669, FAI-671 | [PR #512](https://github.com/flidai/leapview/pull/512), `62d039399`; [PR #546](https://github.com/flidai/leapview/pull/546), `4435ea6c1` | Foreign-scope rejection before source I/O, shared selector and generated-locator rejection, claim validation, cache partition, replay reauthorization, and runtime admission tests | Partial — API-01, API-02, API-05, and API-06 inventories remain non-exhaustive |
...
| ISO-01–ISO-03 | Baseline, FAI-677 | Merged instance claim/runtime topology; this FAI-679 documentation-only candidate incorporates the FAI-677 Project-free mental model | Bound authorization/runtime isolation tests plus explicit top-level rejection of Project selectors, Project pickers, native cross-Project imports, and same-process multi-Project isolation | Candidate — ISO-03 is aligned locally; protected validation and merge remain |
...
| BND-04 | `TestPostgresNativeRefreshFinalizerPreservesLeaseThenTargetLockOrder` in [refresh integration tests](../../internal/refresh/module/postgres_native_finalizer_test.go) covers canonical verification and finalization alongside a competing admission fence using production-strength `FOR UPDATE`, including the publication foreign key's implicit target lock, while preserving the final activation CAS. |
