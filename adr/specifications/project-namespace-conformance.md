...
| ISO-01–ISO-03 | Baseline, FAI-677 | Merged instance claim/runtime topology; FAI-677 has no dedicated merged change | Bound authorization/runtime isolation tests; current public-documentation audit is incomplete | Partial — ISO-03 documentation alignment remains open |
