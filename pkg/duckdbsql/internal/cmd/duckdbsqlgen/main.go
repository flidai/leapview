...
func render(inventory duckdbsql.MetadataInventory) (string, error) {
	...
	b.WriteString("// Code generated by pkg/duckdbsql/internal/cmd/duckdbsqlgen; DO NOT EDIT.\n")
...
func renderSchema(schemas schemaFamilies) (string, error) {
	...
	var b strings.Builder
	b.WriteString("// Code generated by pkg/duckdbsql/internal/cmd/duckdbsqlgen from the pinned DuckDB serializer descriptors; DO NOT EDIT.\n")
