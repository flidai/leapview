...
func schemaRefObject(ref ir.SchemaRef) map[string]any {
	if ref.Ref != "" && ref.Const == nil && ref.Minimum == nil && ref.Maximum == nil && ref.MinLength == nil && ref.MaxLength == nil && ref.MinItems == nil && ref.MaxItems == nil && !ref.UniqueItems && ref.MinProperties == nil && ref.Pattern == "" && ref.PropertyNames == nil {
