...
func TestValidateSchemaRefItemBounds(t *testing.T) {
	...
	doc := Document{
		...
		API:           API{BasePath: "/"},
		Info:          Info{Title: "Contracts", Version: "1.0.0"},
		Endpoints:     []Endpoint{{Method: "post", Path: "/values", OperationID: "values", RequestBody: &RequestBody{Contents: []BodyContent{{ContentType: "application/json", BodyKind: "json", Schema: &SchemaRef{Type: "array", Items: &SchemaRef{Type: "string"}, MinItems: &minItems, MaxItems: &maxItems}}}}, Responses: []Response{{StatusCode: 200, Description: "ok"}}}},
	}
	require.NoError(t, Validate(doc))
