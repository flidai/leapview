...
export function $minProperties(context: DecoratorContext, target: ModelProperty, value: number) {
  ...
  const numeric = Number((value as unknown as { value?: unknown }).value ?? value);
