...
test('mobile homepage keeps the shared navigation and all sections usable', async () => {
  ...
  try {
    ...
    expect(await page.locator('#project-file-title').textContent()).toBe('Declare the dashboard.')
    ...
    expect(await page.locator('#project-file-title').textContent()).toBe('Keep the project current.')
