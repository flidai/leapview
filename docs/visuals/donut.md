...
With outside labels and a bottom legend, the chart reserves label columns as the card resizes. Authored radius proportions are retained within the available plot area; use a small category count to keep the labels readable.
