...
Every alert links to [Operational troubleshooting](/docs/guides/operate/troubleshooting); recovery and dashboard refresh burn alerts link directly to their response sections. Configure routing and receivers in the operator-owned Alertmanager deployment.
