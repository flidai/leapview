...
| Delete | `delete` | The current private draft dashboard | Dashboard content and retained revisions are permanently removed; only audit and idempotency evidence remain; published or restricted dashboards cannot be deleted |
