...
Generation and expiry timestamps are UTC and policy-bounded: future-dated,
stale, malformed, missing, or mismatched evidence fails closed. The same
...
The retained compatibility report is generated by the repository-native tool:
