...
- Access policy and public dashboard publication are target-owned controls rather than source-root configuration resources. Agent provider settings and the system prompt are installation-wide runtime configuration.
