...
```sh
leapview semantic-model ossie export --source-root dashboards --semantic-model sales > sales.ossie.json
leapview semantic-model ossie import --source-root dashboards sales.ossie.json > sales.yaml
```
