...
func TestProjectDataExplorerViewsAuthoredMetricOverridesRemainValidAtMultiMetricGrain(t *testing.T) {
	...
	proportionalSpec.Visualization = &exploration.ExplorationVisualizationConfig{Value: &exploration.ProportionalExplorationVisualization{Kind: "proportional", Mark: exploration.ExplorationVisualizationProportionalMarkDonut, Category: category, Value: value}}
