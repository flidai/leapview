...
type SemanticModelAssetReadModel struct {
	...
	StructuredRelationships map[string]semanticmodel.RelationshipSpec    `json:"StructuredRelationships,omitempty"`
...
func SemanticModelAssetPayload(model *semanticmodel.Model) map[string]any {
	...
	projection := SemanticModelAssetReadModel{
		...
		StructuredRelationships: model.StructuredRelationships,
