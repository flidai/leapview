...
func TestGovernanceFieldsAreProjectedAndAnnotationsExcluded(t *testing.T) {
	...
	const raw = `{"apiVersion":"leapview.dev/v1","kind":"Source","metadata":{"id":"source:orders","name":"orders","contract":{"version":"1.2.3","compatibility":"backward"}},"spec":{"connection":"warehouse","location":{"type":"path","path":"orders.csv","format":"csv"},"schema":{"mode":"strict"},"fields":{"order_id":{"datatype":"String","tags":["identifier"],"criticalDataElement":true,"classification":"restricted","authoritativeDefinitions":[{"type":"transformationImplementation","url":"https://CATALOG.example:443/definitions/../customer%2Did"},{"type":"transformationImplementation","url":"https://catalog.example/customer-id"},{"type":"businessDefinition","url":"https://catalog.example/customer-id"}],"deprecation":{"since":"1.0.0","reason":"Use customer_key instead","replacement":"customer_key"}},"customer_key":{"datatype":"String"}},"checks":[{"id":"order_id_present","type":"non_null","field":"order_id"}]}}`
