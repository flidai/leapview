...
func TestCurrentCrossLanguageFixtureMatchesSourceProjection(t *testing.T) {
	...
	if err := json.Unmarshal([]byte(`{"apiVersion":"leapview.dev/v1","kind":"Source","metadata":{"id":"source:orders","name":"orders"},"spec":{"connection":"connection:warehouse","location":{"type":"relation","name":"orders"},"schema":{"mode":"strict"},"fields":[{"name":"z_field","datatype":"String"},{"name":"a_field","datatype":"Integer"}]}}`), &authored); err != nil {
