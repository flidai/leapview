...
type ContractProjectionDeprecation struct {
...
type ContractProjectionField struct {
	...
	Deprecation              *ContractProjectionDeprecation               `json:"deprecation,omitempty" yaml:"deprecation,omitempty"`
}
...
type ContractProjectionModelBody struct {
	...
	Fields     map[string]ContractProjectionField       `json:"fields" yaml:"fields"`
