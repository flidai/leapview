...
INSERT INTO delivery.delivery_snapshot_seal(seal_id,attempt_id,candidate_id,physical_pool_id,tenant_domain,region,encryption_domain,object_namespace,catalog_database,catalog_id,catalog_uuid,catalog_version,ducklake_snapshot_id,relation_namespace,relation_manifest_digest,object_root,object_root_digest,artifact_root,artifact_root_digest,compiled_graph_digest,compiled_config_digest,security_domain_fingerprint,request_digest,plan_digest,compatibility_digest,serving_artifact_digest,duckdb_version,ducklake_extension_version,ducklake_spec_version,catalog_schema_version,qualification_evidence)
VALUES(sqlc.arg(seal_id)::uuid,sqlc.arg(attempt_id)::uuid,sqlc.arg(candidate_id)::uuid,sqlc.arg(physical_pool_id),sqlc.arg(tenant_domain),sqlc.arg(region),sqlc.arg(encryption_domain),sqlc.arg(object_namespace),sqlc.arg(catalog_database),sqlc.arg(catalog_id),sqlc.arg(catalog_uuid),sqlc.arg(catalog_version),sqlc.arg(ducklake_snapshot_id),sqlc.arg(relation_namespace),sqlc.arg(relation_manifest_digest),sqlc.arg(object_root),sqlc.arg(object_root_digest),sqlc.arg(artifact_root),sqlc.arg(artifact_root_digest),sqlc.arg(compiled_graph_digest),sqlc.arg(compiled_config_digest),sqlc.arg(security_domain_fingerprint),sqlc.arg(request_digest),sqlc.arg(plan_digest),sqlc.arg(compatibility_digest),sqlc.arg(serving_artifact_digest),sqlc.arg(duckdb_version),sqlc.arg(ducklake_extension_version),sqlc.arg(ducklake_spec_version),sqlc.arg(catalog_schema_version),sqlc.arg(qualification_evidence)::jsonb)
ON CONFLICT(seal_id) DO NOTHING;

-- name: GetSnapshotSeal :one
SELECT seal_id::text,attempt_id::text,COALESCE(candidate_id::text,'')::text AS candidate_id,physical_pool_id,tenant_domain,region,encryption_domain,object_namespace,catalog_database,catalog_id,catalog_uuid,catalog_version,ducklake_snapshot_id,relation_namespace,relation_manifest_digest,object_root,object_root_digest,artifact_root,artifact_root_digest,compiled_graph_digest,compiled_config_digest,security_domain_fingerprint,request_digest,plan_digest,compatibility_digest,serving_artifact_digest,duckdb_version,ducklake_extension_version,ducklake_spec_version,catalog_schema_version,qualification_evidence,qualified_at
