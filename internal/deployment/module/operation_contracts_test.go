...
func TestDeploymentLifecycleOperationContracts(t *testing.T) {
	...
	commands := map[string]struct {
		...
		"createDeployment":                      {deploymentQueuedAuditAction, "RESOURCE_PUBLISH", "required", "transactional"},
		"cancelDeployment":                      {deploymentCancelledAuditAction, "RESOURCE_PUBLISH", "required", "transactional"},
		"retryDeployment":                       {deploymentQueuedAuditAction, "RESOURCE_PUBLISH", "required", "transactional"},
		"rollbackDeployment":                    {deploymentQueuedAuditAction, "PROJECT_ADMIN", "required", "transactional"},
		"requestDeploymentApproval":             {deploymentApprovalRequestedAuditAction, "RESOURCE_PUBLISH", "required", "transactional"},
		"approveDeployment":                     {deploymentApprovedAuditAction, "PROJECT_ADMIN", "required", "transactional"},
		"denyDeploymentApproval":                {deploymentDeniedAuditAction, "PROJECT_ADMIN", "required", "transactional"},
		"revokeDeploymentApproval":              {deploymentApprovalRevokedAuditAction, "PROJECT_ADMIN", "required", "transactional"},
		"activateDeployment":                    {deploymentActivationRequestedAuditAction, "PROJECT_ADMIN", "required", "transactional"},
