...
func (h Handler) RegisterSemanticAttribute(w stdhttp.ResponseWriter, r *stdhttp.Request) {
	...
	err = executeSemanticAttributeMutation(r, accessgen.GenCommandOperationRegisterSemanticAttribute(), "", func() error {
		var callErr error
...
func (h Handler) UpdateSemanticAttributeMetadata(w stdhttp.ResponseWriter, r *stdhttp.Request) {
	...
	var row access.SemanticAttributeDefinition
	err = executeSemanticAttributeMutation(r, accessgen.GenCommandOperationUpdateSemanticAttributeMetadata(), semanticAttributeDefinitionETag(current), func() error {
		var callErr error
...
func (h Handler) setSemanticAttributeEnabled(w stdhttp.ResponseWriter, r *stdhttp.Request, enabled bool, operation accessgen.GenCommandOperationID) {
	...
	var row access.SemanticAttributeDefinition
	err = executeSemanticAttributeMutation(r, operation, semanticAttributeDefinitionETag(current), func() error {
		var callErr error
