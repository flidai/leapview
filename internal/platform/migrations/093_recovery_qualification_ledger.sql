...
CREATE TABLE recovery_qualification_occurrences (
  ...
  qualification_duration_millis INTEGER CHECK (qualification_duration_millis IS NULL OR qualification_duration_millis >= 0),
  ...
  evidence_status TEXT NOT NULL DEFAULT 'pending'
    CHECK (evidence_status IN ('pending', 'claimed', 'published', 'failed', 'none')),
