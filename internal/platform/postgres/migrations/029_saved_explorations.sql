...
GRANT SELECT, INSERT ON saved_exploration.saved_exploration_revisions TO leapview_control_runtime;
GRANT SELECT, INSERT ON saved_exploration.saved_exploration_operations TO leapview_control_runtime;
...
ALTER DEFAULT PRIVILEGES FOR ROLE leapview_control_owner
    ...
    GRANT SELECT, INSERT, UPDATE ON TABLES TO leapview_control_runtime;
ALTER DEFAULT PRIVILEGES FOR ROLE leapview_control_owner
    IN SCHEMA saved_exploration
...
-- +goose StatementBegin
DO $$ BEGIN
    RAISE EXCEPTION 'saved exploration history is immutable; destructive down is forbidden';
END $$;
-- +goose StatementEnd
RESET ROLE;
