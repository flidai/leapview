...
--
-- This is a forward-only global control-plane migration. Attribute
-- assignments, trusted claim mappings, and generation references deliberately
-- remain outside this registry slice.
...
CREATE INDEX IF NOT EXISTS semantic_attribute_definition_owner_idx
...
DROP TRIGGER IF EXISTS semantic_attribute_registry_no_delete ON access.semantic_attribute_registry;
...
DROP TRIGGER IF EXISTS semantic_attribute_registry_immutable ON access.semantic_attribute_registry;
...
DROP TRIGGER IF EXISTS semantic_attribute_definition_no_delete ON access.semantic_attribute_definition;
CREATE TRIGGER semantic_attribute_definition_no_delete
    BEFORE DELETE ON access.semantic_attribute_definition
    FOR EACH ROW EXECUTE FUNCTION access.reject_access_delete();
DROP TRIGGER IF EXISTS semantic_attribute_definition_immutable ON access.semantic_attribute_definition;
