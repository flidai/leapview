...
func retainedUpgradePublicationInput(t *testing.T) contractpublication.ContractPublicationInput {
	...
	const raw = `{"apiVersion":"leapview.dev/v1","kind":"Source","metadata":{"id":"source:orders","name":"orders"},"spec":{"connection":"warehouse","location":{"type":"path","path":"orders.csv","format":"csv"},"schema":{"mode":"strict"},"fields":[{"name":"id","datatype":"Integer"}]}}`
