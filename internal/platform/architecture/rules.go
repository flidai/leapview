...
var PublicContractPrefixes = map[string][]string{
	"access":        {"pkg/authority", "pkg/permissions", "internal/access", "internal/access/api", "internal/access/policy", "internal/access/snapshot", "internal/access/ui/signals"},
...
var SharedContractPrefixes = map[string][]string{
	...
	"refresh":      {"internal/project/graph", "internal/project/manifest", "internal/project/contracts/pipelineplan", "internal/project/contractprojection", "internal/project/contractversion", "internal/project/contractpublication", "internal/release", "internal/analytics/catalogstats", "internal/analytics/query/planir"},
...
var PackageRules = []PackageRule{
	...
	{Prefix: "pkg/permissions", Capability: "access", Layer: LayerContract},
	...
	{Prefix: "internal/dashboard/document", Capability: "dashboard", Layer: LayerContract},
	...
	{Prefix: "internal/dashboard/querymap", Capability: "dashboard", Layer: LayerContract},
	...
	{Prefix: "internal/access/revalidation", Capability: "access", Layer: LayerUseCase},
	{Prefix: "internal/access/rolebindings", Capability: "access", Layer: LayerUseCase},
