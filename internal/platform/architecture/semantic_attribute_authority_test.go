...
// the global platform migrations and access-owned direct-pgx repositories.
func TestSemanticAttributeAuthorityIsTypedAndControlPlaneOwned(t *testing.T) {
	...
	typedFiles := []string{
		"internal/platform/postgres/migrations/011_typed_attribute_registry.sql",
		"internal/platform/postgres/migrations/012_semantic_attribute_control.sql",
