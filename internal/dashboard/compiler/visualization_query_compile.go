...
func compileSecondaryQueryBindings(ctx compileContext, authored dashboardauthoring.Visual) (map[string]visualizationdefinition.QueryBinding, error) {
...
func compileVisualizationQueryBinding(ctx compileContext, authored dashboardauthoring.Visual) (visualizationdefinition.QueryBinding, error) {
	...
	binding := visualizationdefinition.QueryBinding{
		...
		Aggregate: &visualizationdefinition.AggregateQueryBinding{
			TableID: authored.Query.Table, Dimensions: compiledFields(authored.Query.Dimensions), Metrics: compiledFields(authored.Query.Metrics),
...
func compiledVisualResultShape(authored dashboardauthoring.Visual) (visualizationdefinition.ResultShape, error) {
	if _, ok := dashboardauthoring.VisualizationCapabilityForType(authored.Type); !ok {
...
func compiledSpatialBinding(modelID string, authored dashboardauthoring.Visual, model *semanticmodel.Model) (visualizationdefinition.QueryBinding, error) {
...
func geographicUsesTiledDelivery(authored dashboardauthoring.Visual) (bool, error) {
...
func authoredTiledCoordinates(layers []dashboardauthoring.VisualGeoLayer) (latitude, longitude string, found bool, err error) {
...
func tiledCellRadius(layers []dashboardauthoring.VisualGeoLayer) int32 {
	radius := 0.0
	for _, layer := range layers {
		switch layer.Kind {
		case "point":
...
func compiledVisualLimit(authored dashboardauthoring.Visual) int64 {
	if authored.DataBudget.MaxRows > 0 {
...
func compiledVisualFrameLimit(authored dashboardauthoring.Visual, shape string) int64 {
	limit := compiledVisualLimit(authored)
	if authored.DataBudget.MaxRows > 0 {
		return limit
	}
...
func compiledVisualDataBudgetMaxRows(authored dashboardauthoring.Visual, shape string) int64 {
	if authored.DataBudget.MaxRows > 0 {
		return int64(authored.DataBudget.MaxRows)
	}
...
func compiledTableBinding(modelID, visualType string, authored dashboardauthoring.TableVisual) visualizationdefinition.QueryBinding {
	binding := visualizationdefinition.QueryBinding{
	...
	case "matrix":
		...
		binding.Matrix = &visualizationdefinition.MatrixQueryBinding{
			TableID: authored.Query.Table, Rows: compiledFields(authored.Query.Rows), Columns: compiledFields(authored.Query.Columns), Metrics: compiledFields(authored.Query.Metrics), Limit: dashboard.TableInteractiveRowCap,
		}
	case "pivot":
...
func compiledFields(fields []dashboardauthoring.FieldRef) []visualizationdefinition.FieldBinding {
...
func compiledVisualFields(query dashboardauthoring.VisualQuery) []visualizationdefinition.FieldBinding {
...
func compiledOptionalField(field dashboardauthoring.FieldRef) *visualizationdefinition.FieldBinding {
	values := compiledFields([]dashboardauthoring.FieldRef{field})
	if len(values) == 0 {
		return nil
	}
	return &values[0]
...
func compiledTime(value dashboardauthoring.QueryTime) *visualizationdefinition.TimeBinding {
	if value.Field == "" {
		return nil
	}
	alias := value.Alias
...
func compiledTableFields(table dashboardauthoring.TableVisual) []visualizationdefinition.FieldBinding {
...
func compiledSort(values []dashboardauthoring.Sort) []visualizationdefinition.Sort {
