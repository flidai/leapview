...
func TestValidateSpecRejectsConditionalFormattingTargetsOutsideVisibleChannels(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "line mark stroke", valid: cartesian(VisualizationCartesianMarkLine, []VisualizationFieldRef{ref("value")}, format("value", VisualizationConditionalTargetMarkFill)), invalid: cartesian(VisualizationCartesianMarkLine, []VisualizationFieldRef{ref("value")}, format("value", VisualizationConditionalTargetMarkStroke)), want: "lineStyle.color cannot apply row callbacks"},
		{name: "area mark stroke", valid: cartesian(VisualizationCartesianMarkArea, []VisualizationFieldRef{ref("value")}, format("value", VisualizationConditionalTargetMarkFill)), invalid: cartesian(VisualizationCartesianMarkArea, []VisualizationFieldRef{ref("value")}, format("value", VisualizationConditionalTargetMarkStroke)), want: "lineStyle.color cannot apply row callbacks"},
