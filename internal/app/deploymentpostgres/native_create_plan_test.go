...
func TestRichPlanFromRequestCarriesActorSourceOwnerAndBaseFence(t *testing.T) {
	...
	request := deployment.DeliveryPlanRequest{
		...
		Governance: deployment.DeliveryGovernance{PolicyDigest: d('3'), PolicyRevision: 1, AuthorizationDigest: d('4'), QualificationDigest: d('5'), ApprovalPolicyRevision: 1, ExpiresAt: now.Add(time.Hour)},
