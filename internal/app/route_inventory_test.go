...
func TestRouteInventory(t *testing.T) {
	...
	sort.Strings(rows)
	// Recomputed from the target-policy route inventory on current main.
	const expectedRouteContractDigest = "13d5742fb270b98bf3a749d163b614f522d68e24c8bc84d8d26dc8987201952f"
