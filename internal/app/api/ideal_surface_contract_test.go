...
func TestIdealV1Surface(t *testing.T) {
	...
	required := map[string][]string{
		...
		"/api/v1/projects/{project}/delivery":                                                                 {"post"},
		"/api/v1/projects/{project}/delivery/plans/{plan}":                                                    {"get"},
		"/api/v1/projects/{project}/delivery/plans/{plan}/build":                                              {"post"},
		"/api/v1/projects/{project}/delivery/builds/{build}":                                                  {"get"},
		"/api/v1/projects/{project}/delivery/seals/{seal}":                                                    {"get"},
		"/api/v1/projects/{project}/delivery/candidates/{candidate}":                                          {"get"},
		"/api/v1/projects/{project}/delivery/candidates/{candidate}/publish":                                  {"post"},
		"/api/v1/projects/{project}/delivery/generations/{generation}":                                        {"get"},
		"/api/v1/projects/{project}/delivery/generations/{generation}/rollback":                               {"post"},
		"/api/v1/projects/{project}/delivery/publications/{publication}":                                      {"get"},
		"/api/v1/projects/{project}/delivery/publications/{publication}/approval-requests":                    {"post"},
		"/api/v1/projects/{project}/delivery/publications/{publication}/approval-requests/{approval}":         {"get"},
		"/api/v1/projects/{project}/delivery/publications/{publication}/approval-requests/{approval}/approve": {"post"},
		"/api/v1/projects/{project}/delivery/publications/{publication}/approval-requests/{approval}/deny":    {"post"},
		"/api/v1/projects/{project}/delivery/publications/{publication}/approval-requests/{approval}/revoke":  {"post"},
		"/api/v1/projects/{project}/delivery/operator":                                                        {"get"},
		"/api/v1/projects/{project}/candidate-sync/plan":                                                      {"post"},
		"/api/v1/projects/{project}/candidate-sync/source":                                                    {"post"},
		"/api/v1/projects/{project}/candidate-sync/blobs/{digest}":                                            {"put"},
		"/api/v1/dashboards/{dashboard}/pages/{page}":                                                         {"get"},
		"/api/v1/dashboards/{dashboard}/pages/{page}/visuals/{visual}":                                        {"get"},
		"/api/v1/dashboards/{dashboard}/pages/{page}/filters/{filter}":                                        {"get"},
		"/api/v1/dashboards/{dashboard}/pages/{page}/visuals/{visual}/query":                                  {"post"},
		"/api/v1/dashboards/{dashboard}/pages/{page}/filters/{filter}/values":                                 {"post"},
		"/api/v1/semantic-models/{model}/relationships":                                                       {"get"},
		"/api/v1/semantic-models/{model}/sources":                                                             {"get"},
		"/api/v1/projects/{project}/refresh-runs/{run}/events":                                                {"get"},
...
func TestIdealQueryAndEventRepresentations(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{"/api/v1/semantic-models/{model}/query", "post", "application/vnd.apache.arrow.stream"},
		{"/api/v1/semantic-models/{model}/datasets/{dataset}/preview", "post", "application/vnd.apache.arrow.stream"},
		{"/api/v1/dashboards/{dashboard}/pages/{page}/visuals/{visual}/query", "post", "application/vnd.apache.arrow.stream"},
		{"/api/v1/projects/{project}/releases/{release}/events", "get", "text/event-stream"},
		{"/api/v1/projects/{project}/refresh-runs/{run}/events", "get", "text/event-stream"},
...
func TestIdealAPIUsesProblemDetailsAndMutationHeaders(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{"/api/v1/projects/{project}/candidate-sync/plan", "post"},
		{"/api/v1/projects/{project}/candidate-sync/source", "post"},
		{"/api/v1/projects/{project}/refresh-runs", "post"},
