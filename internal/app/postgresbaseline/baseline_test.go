...
func TestProductBaselineComponentOrder(t *testing.T) {
	want := []string{"platform.operation", "platform.cursor_signing", "project", "access", "managed_data", "physical_pool", "deployment", "serving_state", "event", "ducklake", "jobs", "refresh", "lineage", "cache", "queryaudit"}
