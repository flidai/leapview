...
var settings = []Setting{
	...
	{Name: "LEAPVIEW_LOCAL_CHECKOUT_ID", Type: TypeString, Category: "development", Scope: "released local runtime package", Description: "Canonical checkout identity supplied by the local runtime controller for resource labeling.", Lifecycle: "internal"},
	{Name: "LEAPVIEW_LOCAL_OWNER_ID", Type: TypeString, Category: "development", Scope: "released local runtime package", Description: "Owner identity supplied by the local runtime controller for resource labeling.", Lifecycle: "internal"},
