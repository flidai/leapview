...
var settings = []Setting{
	...
	{Name: "LEAPVIEW_AGENT_MODEL", Field: "AgentModel", Type: TypeString, Default: "gpt-6-luna", Category: "agent", Scope: "serve", Description: "Agent model identifier.", Example: "gpt-6-luna", Runtime: true, Lifecycle: "supported", Commented: true},
