...
var settings = []Setting{
	...
	{Name: "LEAPVIEW_AGENT_CREDENTIAL_KEY", Field: "AgentCredentialKey", Type: TypeString, Category: "agent", Scope: "serve", Description: "64-character hexadecimal key protecting administrator-managed agent credentials. Back up independently of the database.", Secret: true, Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_AGENT_CONFIG_FILE", Field: "AgentConfigFile", Type: TypeString, Category: "agent", Scope: "serve", Description: "Deployment-mounted JSON file watched for live agent configuration reloads.", Example: "/run/secrets/leapview-agent.json", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_AGENT_MODEL", Field: "AgentModel", Type: TypeString, Category: "agent", Scope: "serve", Description: "Legacy deployment-selected agent model identifier.", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_AGENT_REASONING_EFFORT", Field: "AgentReasoningEffort", Type: TypeString, Category: "agent", Scope: "serve", Description: "Reasoning effort sent to supported agent models.", Runtime: true, Lifecycle: "supported", Commented: true},
	...
	{Name: "LEAPVIEW_AUTHORING_ARCHIVE", Type: TypeString, Category: "ci", Scope: "authoring package qualification", Description: "Exact released authoring archive supplied to the qualification task.", Lifecycle: "internal"},
	{Name: "LEAPVIEW_AUTHORING_DOCKER_HOST", Type: TypeString, Category: "ci", Scope: "authoring package qualification", Description: "Explicit local Unix Docker socket supplied to the optional authoring lifecycle lane.", Lifecycle: "internal"},
	{Name: "LEAPVIEW_AUTHORING_EVIDENCE_DIR", Type: TypeString, Category: "ci", Scope: "authoring package qualification", Description: "Directory where bounded authoring qualification evidence is written.", Lifecycle: "internal"},
	{Name: "LEAPVIEW_AUTHORING_REQUIRED", Type: TypeBool, Category: "ci", Scope: "authoring package qualification", Description: "Require authoring package prerequisites instead of recording a skipped result.", Default: "false", Lifecycle: "internal"},
	{Name: "LEAPVIEW_AUTHORING_RUN_LIFECYCLE", Type: TypeBool, Category: "ci", Scope: "authoring package qualification", Description: "Enable the opt-in released-archive init and local development lifecycle lane.", Default: "false", Lifecycle: "internal"},
	...
	{Name: "LEAPVIEW_CONTRIBUTOR_DIAGNOSTICS", Field: "ContributorDiagnostics", Type: TypeBool, Category: "development", Scope: "serve", Description: "Enable source-contributor browser diagnostics; disabled by default independently of the serving environment.", Default: "false", Runtime: true, Lifecycle: "development", Commented: true},
	{Name: "LEAPVIEW_CSRF_KEY", Field: "CSRFKey", Type: TypeString, Category: "security", Scope: "serve", Description: "Key used for CSRF protection and OAuth state cookies; requires at least 32 characters.", Example: SecretPlaceholder, Secret: true, Runtime: true, Lifecycle: "supported", EnvExample: "replace-with-at-least-32-characters"},
	...
	{Name: "LEAPVIEW_DEV_BROWSER_SESSION_TTL", Field: "DevBrowserSessionTTL", Type: TypeDuration, Category: "authentication", Scope: "serve", Description: "Optional browser-session lifetime for loopback development; production keeps the standard lifetime.", Runtime: true, Lifecycle: "development", Commented: true},
	{Name: "LEAPVIEW_DEV_COOKIE_NAMESPACE", Field: "DevCookieNamespace", Type: TypeString, Category: "authentication", Scope: "serve", Description: "Cookie-name suffix isolating one loopback development worktree from others on localhost.", Runtime: true, Lifecycle: "development", Commented: true},
	{Name: "LEAPVIEW_DEV_QUICK_LOGIN", Field: "DevQuickLogin", Type: TypeBool, Category: "authentication", Scope: "serve", Description: "Offer the durable local developer sign-in shortcut on a loopback development server; forbidden in production.", Default: "false", Runtime: true, Lifecycle: "development", Commented: true},
	...
	{Name: "LEAPVIEW_DEV_BOOTSTRAP_TOKEN", Type: TypeString, Category: "development", Scope: "dev server", Description: "Private typed bootstrap token prepared by the managed development server.", Secret: true, Lifecycle: "internal"},
	{Name: "LEAPVIEW_DEV_CANDIDATE_KEY", Type: TypeString, Category: "development", Scope: "dev server", Description: "Explicit private candidate key for an authorized development publication.", Lifecycle: "development"},
	{Name: "LEAPVIEW_DEV_ROTATE_PUBLISHER", Type: TypeBool, Default: "false", Category: "development", Scope: "dev server", Description: "Revoke and replace the scoped development publisher token during credential preparation.", Lifecycle: "development"},
	...
	{Name: "LEAPVIEW_DEV_MCP_METRIC", Type: TypeString, Default: "revenue", Category: "development", Scope: "dev server", Description: "Metric queried by the development MCP smoke check.", Lifecycle: "development"},
	{Name: "LEAPVIEW_DEV_MCP_MODEL_QUERY", Type: TypeString, Default: "sales", Category: "development", Scope: "dev server", Description: "Catalog search query used to select the semantic model for the development MCP smoke check.", Lifecycle: "development"},
	...
	{Name: "LEAPVIEW_DEV_PROJECT_ID", Type: TypeString, Default: "project:leapview-showcase", Category: "development", Scope: "dev server", Description: "Project identifier used by the managed development server and agent end-to-end workflow.", Lifecycle: "development"},
	{Name: "LEAPVIEW_DEV_SOURCE_ROOT", Type: TypeString, Default: "dashboards", Category: "development", Scope: "dev server", Description: "Analytics source root published by the managed development server.", Lifecycle: "development"},
	...
	{Name: "LEAPVIEW_DEV_RESET_LOGIN", Type: TypeBool, Default: "false", Category: "development", Scope: "dev server", Description: "Explicitly restore the private local development login during credential preparation.", Lifecycle: "development"},
	...
	{Name: "LEAPVIEW_DEV_SKIP_DATA_SYNC", Type: TypeBool, Default: "false", Category: "development", Scope: "dev server", Description: "Reuse staged managed data instead of opening new upload sessions during development publication.", Lifecycle: "development"},
	...
	{Name: "LEAPVIEW_DEVELOPMENT_CREDENTIAL_VARIABLES", Field: "DevelopmentCredentialVariables", Type: TypeString, Category: "connection", Scope: "serve", Description: "Exact comma-separated local profile credential variables admitted by the development resolver.", Runtime: true, Lifecycle: "development", Commented: true},
	...
	{Name: "LEAPVIEW_POSTGRES_CONTROL_MIGRATOR_URL", Field: "PostgresControlMigratorURL", Type: TypeString, Category: "postgres", Scope: "initialization operation", Description: "Explicit PostgreSQL control-plane migration connection URL; never opened by production serving.", Example: SecretPlaceholder, Secret: true, Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_POSTGRES_CONTROL_MIGRATOR_ROLE", Field: "PostgresControlMigratorRole", Type: TypeString, Default: "leapview_control_migrator", Category: "postgres", Scope: "initialization operation", Description: "Provisioned canonical PostgreSQL role used by explicit control-plane migrations; custom role names are rejected.", Example: "leapview_control_migrator", Runtime: true, Lifecycle: "supported", Commented: true},
	...
	{Name: "LEAPVIEW_POSTGRES_CONTROL_UPGRADE_COORDINATOR_ROLE", Field: "PostgresControlUpgradeCoordinatorRole", Type: TypeString, Default: "leapview_control_upgrade_coordinator", Category: "postgres", Scope: "upgrade operation", Description: "Provisioned canonical PostgreSQL role used by the DuckLake upgrade coordinator connection; custom role names are rejected.", Example: "leapview_control_upgrade_coordinator", Runtime: true, Lifecycle: "supported", Commented: true},
	...
	{Name: "LEAPVIEW_POSTGRES_CONTROL_READONLY_ROLE", Field: "PostgresControlReadonlyRole", Type: TypeString, Default: "leapview_control_readonly", Category: "postgres", Scope: "serve", Description: "Provisioned canonical PostgreSQL role used by the optional control-plane readonly pool; custom role names are rejected.", Example: "leapview_control_readonly", Runtime: true, Lifecycle: "supported", Commented: true},
	...
	{Name: "LEAPVIEW_POSTGRES_CONTROL_MAINTENANCE_ROLE", Field: "PostgresControlMaintenanceRole", Type: TypeString, Default: "leapview_control_maintenance", Category: "postgres", Scope: "maintenance operation", Description: "Provisioned canonical PostgreSQL role used by bounded control-plane maintenance operations; custom role names are rejected.", Example: "leapview_control_maintenance", Runtime: true, Lifecycle: "supported", Commented: true},
	...
	{Name: "LEAPVIEW_POSTGRES_DUCKLAKE_MIGRATOR_ROLE", Field: "PostgresDuckLakeMigratorRole", Type: TypeString, Default: "leapview_ducklake_migrator", Category: "postgres", Scope: "upgrade operation", Description: "Provisioned canonical PostgreSQL role used by the DuckLake catalog migration connection; custom role names are rejected.", Example: "leapview_ducklake_migrator", Runtime: true, Lifecycle: "supported", Commented: true},
	...
	{Name: "LEAPVIEW_POSTGRES_DUCKLAKE_MAINTENANCE_ROLE", Field: "PostgresDuckLakeMaintenanceRole", Type: TypeString, Default: "leapview_ducklake_maintenance", Category: "postgres", Scope: "maintenance operation", Description: "Provisioned canonical PostgreSQL role used by bounded DuckLake catalog expiry and cleanup operations; custom role names are rejected.", Example: "leapview_ducklake_maintenance", Runtime: true, Lifecycle: "supported", Commented: true},
	...
	{Name: "LEAPVIEW_POSTGRES_CONTROL_RUNTIME_ROLE", Field: "PostgresControlRuntimeRole", Type: TypeString, Default: "leapview_control_runtime", Category: "postgres", Scope: "serve", Description: "Provisioned canonical PostgreSQL role used by the control-plane pool; custom role names are rejected.", Example: "leapview_control_runtime", Runtime: true, Lifecycle: "supported", Commented: true},
	...
	{Name: "LEAPVIEW_POSTGRES_DUCKLAKE_RUNTIME_ROLE", Field: "PostgresDuckLakeRuntimeRole", Type: TypeString, Default: "leapview_ducklake_runtime", Category: "postgres", Scope: "serve", Description: "Provisioned canonical PostgreSQL role used by the DuckLake catalog pool; custom role names are rejected.", Example: "leapview_ducklake_runtime", Runtime: true, Lifecycle: "supported", Commented: true},
	...
	{Name: "LEAPVIEW_POSTGRES_REQUIRE_TLS", Field: "PostgresRequireTLS", Type: TypeBool, Default: "true", Category: "postgres", Scope: "serve", Description: "Require PostgreSQL URLs to use sslmode=verify-full, authenticating both the server certificate chain and hostname.", Example: "true", Runtime: true, Lifecycle: "supported", Commented: true},
	...
	{Name: "LEAPVIEW_RECOVERY_SET_ID", Field: "RecoverySetID", Type: TypeString, Category: "recovery", Scope: "serve", Description: "Optional exact recovery-set UUID required for production pre-traffic validation; readiness reads only this immutable ID.", Runtime: true, Lifecycle: "supported", Commented: true},
	...
	{Name: "LEAPVIEW_JOB_EXECUTION_TIMEOUT", Field: "JobExecutionTimeout", Type: TypeDuration, Default: "24h", Category: "jobs", Scope: "serve", Description: "River worker execution deadline, independent of renewable capability leases.", Runtime: true, Lifecycle: "supported", Commented: true},
	...
	{Name: "LEAPVIEW_DASHBOARD_PREWARM_PUBLICATION_IDS", Field: "DashboardPrewarmPublicationIDs", Type: TypeString, Default: "", Category: "analytics", Scope: "serve", Description: "Comma-separated durable public publication row IDs to prewarm locally; empty disables prewarming.", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_DASHBOARD_PREWARM_MAX_PUBLICATIONS", Field: "DashboardPrewarmMaxPublications", Type: TypeInt, Default: "4", Category: "analytics", Scope: "serve", Description: "Maximum explicitly selected publications to prewarm.", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_DASHBOARD_PREWARM_MAX_TARGETS", Field: "DashboardPrewarmMaxTargets", Type: TypeInt, Default: "16", Category: "analytics", Scope: "serve", Description: "Maximum default-page targets per warm refresh; larger pages are skipped.", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_DASHBOARD_PREWARM_DEADLINE", Field: "DashboardPrewarmDeadline", Type: TypeDuration, Default: "10s", Category: "analytics", Scope: "serve", Description: "Deadline for a local public dashboard warm refresh.", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_DASHBOARD_PREWARM_CONCURRENCY", Field: "DashboardPrewarmConcurrency", Type: TypeInt, Default: "1", Category: "analytics", Scope: "serve", Description: "Warm refresh concurrency; the initial implementation accepts only 1.", Runtime: true, Lifecycle: "supported", Commented: true},
	...
	{Name: "LEAPVIEW_SITE_LOCK_FD", Type: TypeInt, Category: "deployment", Scope: "public-site deployment scripts", Description: "Inherited file descriptor number for the site mutation lock; set internally when scripts invoke one another.", Example: "9", Lifecycle: "internal"},
	{Name: "LEAPVIEW_SITE_MIN_FREE_BYTES", Type: TypeInt64, Default: "5368709120", Category: "deployment", Scope: "public-site operator", Description: "Minimum free bytes required on Docker's image-storage filesystem before public-site image pulls.", Example: "5368709120", Lifecycle: "tooling"},
	...
	{Name: "LEAPVIEW_SITE_STORAGE_PATH", Type: TypeString, Category: "deployment", Scope: "public-site operator", Description: "Optional existing directory on the filesystem holding Docker image storage, used to override automatic backend detection.", Lifecycle: "tooling"},
	...
	{Name: "LEAPVIEW_LOCAL_APP_PORT", Type: TypeInt, Category: "development", Scope: "released local runtime package", Description: "Checkout-scoped loopback host port selected by the local runtime controller.", Lifecycle: "internal"},
	{Name: "LEAPVIEW_DEVELOPMENT_CREDENTIAL_ENV_FILE", Type: TypeString, Category: "connection", Scope: "released local runtime package", Description: "Checkout-owned private Compose env-file containing only selected development credential bundles.", Lifecycle: "internal"},
	{Name: "LEAPVIEW_LOCAL_CHECKOUT_ID", Field: "LocalCheckoutID", Type: TypeString, Category: "development", Scope: "released local runtime package", Description: "Canonical checkout identity supplied by the local runtime controller for resource labeling and profile admission.", Runtime: true, Lifecycle: "internal"},
	{Name: "LEAPVIEW_LOCAL_OWNER_ID", Field: "LocalOwnerID", Type: TypeString, Category: "development", Scope: "released local runtime package", Description: "Owner identity supplied by the local runtime controller for resource labeling and profile admission.", Runtime: true, Lifecycle: "internal"},
	{Name: "LEAPVIEW_DEVELOPMENT_PROFILE_NAME", Field: "DevelopmentProfileName", Type: TypeString, Category: "development", Scope: "released local runtime package", Description: "Exact selected local profile name used by runtime admission.", Runtime: true, Lifecycle: "internal"},
	{Name: "LEAPVIEW_DEVELOPMENT_GRAPH_DIGEST", Field: "DevelopmentGraphDigest", Type: TypeString, Category: "development", Scope: "released local runtime package", Description: "Exact compiled graph identity used by local profile admission.", Runtime: true, Lifecycle: "internal"},
	{Name: "LEAPVIEW_DEVELOPMENT_PROFILE_DIGEST", Field: "DevelopmentProfileDigest", Type: TypeString, Category: "development", Scope: "released local runtime package", Description: "Exact non-secret selected profile identity used by local profile admission.", Runtime: true, Lifecycle: "internal"},
	...
	{Name: "LEAPVIEW_MANAGED_DATA_BACKEND", Field: "ManagedDataBackend", Type: TypeString, Default: "local", Category: "managed data", Scope: "serve", Description: "Storage backend for project-global managed data; supported values are local and s3. Production local storage requires provider-native volume snapshot protection.", Runtime: true, Lifecycle: "supported", EnvExample: "local"},
	...
	{Name: "LEAPVIEW_MANAGED_DATA_S3_OBSERVATION_ACCOUNT", Field: "ManagedDataS3ObservationAccount", Type: TypeString, Category: "managed data", Scope: "serve", Description: "Non-secret provider account identity used to bind managed-data S3 write observations.", Example: "123456789012", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_MANAGED_DATA_S3_OBSERVATION_PROFILE_ID", Field: "ManagedDataS3ObservationProfileID", Type: TypeString, Category: "managed data", Scope: "serve", Description: "Non-secret stable provider profile identity used to bind managed-data S3 write observations.", Example: "managed-data-production", Runtime: true, Lifecycle: "supported", Commented: true},
	...
	{Name: "LEAPVIEW_OBJECT_STORE_BACKEND", Field: "ObjectStoreBackend", Type: TypeString, Default: "filesystem", Category: "object store", Scope: "serve", Description: "Immutable object-store backend for project sources and compiled serving artifacts; supported values are filesystem and s3. Production filesystem storage requires provider-native volume snapshot protection.", Runtime: true, Lifecycle: "supported", EnvExample: "filesystem"},
	...
	{Name: "LEAPVIEW_OBJECT_STORE_S3_ENCRYPTION_MODE", Field: "ObjectStoreS3EncryptionMode", Type: TypeString, Default: "AES256", Category: "object store", Scope: "serve", Description: "Explicit server-side encryption mode for immutable object-store S3 objects: AES256 (SSE-S3), aws:kms (SSE-KMS), or sse-c (SSE-C).", Example: "AES256", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_OBJECT_STORE_S3_ENCRYPTION_KEY_REF", Field: "ObjectStoreS3EncryptionKeyRef", Type: TypeString, Category: "object store", Scope: "serve", Description: "Opaque application encryption-key epoch reference for immutable object-store S3 encryption; never sent to S3 as a key ID.", Example: "prod-object-store", Runtime: true, Lifecycle: "supported", Commented: true},
	...
	{Name: "LEAPVIEW_OBJECT_STORE_S3_ENCRYPTION_CUSTOMER_KEY", Field: "ObjectStoreS3EncryptionCustomerKey", Type: TypeString, Category: "object store", Scope: "serve", Description: "Secret standard-base64 32-byte customer key used for immutable object-store S3 SSE-C requests.", Example: SecretPlaceholder, Secret: true, Runtime: true, Lifecycle: "supported", Commented: true},
	...
	{Name: "LEAPVIEW_POSTGRES_HA_EVIDENCE_DIR", Type: TypeString, Category: "ci", Scope: "local PostgreSQL HA qualification", Description: "Optional directory for redacted PostgreSQL HA qualification evidence.", Lifecycle: "internal"},
	{Name: "LEAPVIEW_POSTGRES_HA_REPLICATION_PASSWORD", Type: TypeString, Category: "ci", Scope: "local PostgreSQL HA qualification", Description: "Disposable replication credential for the PostgreSQL HA qualification fixture.", Secret: true, Lifecycle: "internal"},
	{Name: "LEAPVIEW_POSTGRES_HA_REWIND_PASSWORD", Type: TypeString, Category: "ci", Scope: "local PostgreSQL HA qualification", Description: "Disposable rewind credential for the PostgreSQL HA qualification fixture.", Secret: true, Lifecycle: "internal"},
	{Name: "LEAPVIEW_POSTGRES_HA_SUPERUSER_PASSWORD", Type: TypeString, Category: "ci", Scope: "local PostgreSQL HA qualification", Description: "Disposable superuser credential for the PostgreSQL HA qualification fixture.", Secret: true, Lifecycle: "internal"},
	{Name: "LEAPVIEW_POSTGRES_HA_WAIT_SECONDS", Type: TypeInt, Default: "120", Category: "ci", Scope: "local PostgreSQL HA qualification", Description: "Bounded wait in seconds for each PostgreSQL HA qualification transition.", Lifecycle: "internal"},
	...
	{Name: "LEAPVIEW_REQUIRE_ACTIVE_DEPLOYMENT", Field: "RequireActiveDeployment", Type: TypeBool, Category: "server", Scope: "serve", Description: "Require an active serving deployment before readiness succeeds; production always enables this contract.", Default: "false", Runtime: true, Lifecycle: "supported", Commented: true},
	...
	{Name: "LEAPVIEW_QUALIFICATION_REQUIRED", Type: TypeBool, Category: "ci", Scope: "authoring package qualification", Description: "Make missing qualification prerequisites fail the released-artifact gate.", Default: "false", Lifecycle: "internal"},
	{Name: "LEAPVIEW_QUALIFICATION_RUN_LIFECYCLE", Type: TypeBool, Category: "ci", Scope: "authoring package qualification", Description: "Enable the qualification harness lifecycle lane for an exact archive.", Default: "false", Lifecycle: "internal"},
	...
	{Name: "LEAPVIEW_QA_DISPOSABLE", Type: TypeBool, Default: "false", Category: "development", Scope: "ui-qa", Description: "Marks the isolated QA server whose database is destroyed after browser mutation checks.", Lifecycle: "internal"},
	{Name: "LEAPVIEW_QA_STORAGE_STATE", Type: TypeString, Category: "development", Scope: "ui-qa", Description: "Private Playwright browser-session file used by authenticated route and visual QA.", Lifecycle: "internal"},
...
var (
	...
	objectStoreSSEC   = Equals("LEAPVIEW_OBJECT_STORE_S3_ENCRYPTION_MODE", "sse-c")
)

var rules = []Rule{
	{ID: "agent-reasoning-effort", Description: "Agent reasoning effort uses a supported API value.", When: Present("LEAPVIEW_AGENT_REASONING_EFFORT"), Assert: OneOf("LEAPVIEW_AGENT_REASONING_EFFORT", "none", "low", "medium", "high", "xhigh", "max"), Message: "LEAPVIEW_AGENT_REASONING_EFFORT must be none, low, medium, high, xhigh, or max"},
	...
	{ID: "csrf-key", Description: "A CSRF key must contain at least 32 characters.", Assert: MinLength("LEAPVIEW_CSRF_KEY", 32), Message: "serve requires LEAPVIEW_CSRF_KEY with at least 32 characters"},
	...
	{ID: "production-managed-data-s3-endpoint", Description: "Production custom managed-data S3 endpoints must use encrypted transport.", When: All(production, managedS3, Present("LEAPVIEW_MANAGED_DATA_S3_ENDPOINT")), Assert: HTTPSURL("LEAPVIEW_MANAGED_DATA_S3_ENDPOINT"), Message: "production managed-data S3 custom endpoints must use HTTPS"},
	{ID: "production-managed-data-s3-observation-profile", Description: "Production managed-data S3 writes require an explicit provider observation profile.", When: All(production, managedS3), Assert: All(Present("LEAPVIEW_MANAGED_DATA_S3_OBSERVATION_ACCOUNT"), Present("LEAPVIEW_MANAGED_DATA_S3_OBSERVATION_PROFILE_ID")), Message: "production managed-data S3 requires LEAPVIEW_MANAGED_DATA_S3_OBSERVATION_ACCOUNT and LEAPVIEW_MANAGED_DATA_S3_OBSERVATION_PROFILE_ID"},
	...
	{ID: "production-object-store-s3-endpoint", Description: "Production custom immutable-object S3 endpoints must use encrypted transport.", When: All(production, objectStoreS3, Present("LEAPVIEW_OBJECT_STORE_S3_ENDPOINT")), Assert: HTTPSURL("LEAPVIEW_OBJECT_STORE_S3_ENDPOINT"), Message: "production object-store S3 custom endpoints must use HTTPS"},
	...
	{ID: "object-store-s3-encryption-mode", Description: "Immutable object-store S3 encryption is explicit and supported.", When: objectStoreS3, Assert: Any(objectStoreSSES3, objectStoreKMS, objectStoreSSEC), Message: "LEAPVIEW_OBJECT_STORE_S3_ENCRYPTION_MODE must be AES256 (SSE-S3), aws:kms (SSE-KMS), or sse-c (SSE-C)"},
	{ID: "object-store-s3-sse-s3-keys", Description: "SSE-S3 does not accept encryption key identities.", When: All(objectStoreS3, objectStoreSSES3), Assert: All(Not(Present("LEAPVIEW_OBJECT_STORE_S3_ENCRYPTION_KEY_REF")), Not(Present("LEAPVIEW_OBJECT_STORE_S3_ENCRYPTION_PROVIDER_KEY")), Not(Present("LEAPVIEW_OBJECT_STORE_S3_ENCRYPTION_CUSTOMER_KEY"))), Message: "SSE-S3 object storage must not set encryption key references, provider keys, or customer keys"},
	{ID: "object-store-s3-sse-kms-keys", Description: "SSE-KMS requires both opaque and resolved provider key identities and no customer key.", When: All(objectStoreS3, objectStoreKMS), Assert: All(Present("LEAPVIEW_OBJECT_STORE_S3_ENCRYPTION_KEY_REF"), Present("LEAPVIEW_OBJECT_STORE_S3_ENCRYPTION_PROVIDER_KEY"), Not(Present("LEAPVIEW_OBJECT_STORE_S3_ENCRYPTION_CUSTOMER_KEY"))), Message: "SSE-KMS object storage requires an opaque key reference and resolved provider key, and must not set a customer key"},
	{ID: "object-store-s3-sse-c-keys", Description: "SSE-C requires an opaque key epoch and customer key without a provider key.", When: All(objectStoreS3, objectStoreSSEC), Assert: All(Present("LEAPVIEW_OBJECT_STORE_S3_ENCRYPTION_KEY_REF"), Present("LEAPVIEW_OBJECT_STORE_S3_ENCRYPTION_CUSTOMER_KEY"), Not(Present("LEAPVIEW_OBJECT_STORE_S3_ENCRYPTION_PROVIDER_KEY"))), Message: "SSE-C object storage requires LEAPVIEW_OBJECT_STORE_S3_ENCRYPTION_KEY_REF and LEAPVIEW_OBJECT_STORE_S3_ENCRYPTION_CUSTOMER_KEY, and must not set a provider key"},
	{ID: "object-store-s3-sse-c-endpoint", Description: "A configured SSE-C custom endpoint must use HTTPS; the AWS default endpoint is also supported.", When: All(objectStoreS3, objectStoreSSEC), Assert: Any(Not(Present("LEAPVIEW_OBJECT_STORE_S3_ENDPOINT")), HTTPSURL("LEAPVIEW_OBJECT_STORE_S3_ENDPOINT")), Message: "SSE-C object storage custom endpoints must use HTTPS"},
}
