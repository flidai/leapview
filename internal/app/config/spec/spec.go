...
var settings = []Setting{
	...
	{Name: "LEAPVIEW_POSTGRES_CONTROL_MIGRATOR_URL", Field: "PostgresControlMigratorURL", Type: TypeString, Category: "postgres", Scope: "serve,admin", Description: "Explicit PostgreSQL control-plane migration URL; used only before readiness.", Example: SecretPlaceholder, Secret: true, Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_POSTGRES_CONTROL_MIGRATOR_ROLE", Field: "PostgresControlMigratorRole", Type: TypeString, Default: "leapview_control_migrator", Category: "postgres", Scope: "serve,admin", Description: "Canonical PostgreSQL role expected by the control-plane migration pool; other role names are rejected by foundation validation.", Example: "leapview_control_migrator", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_POSTGRES_DUCKLAKE_MIGRATOR_URL", Field: "PostgresDuckLakeMigratorURL", Type: TypeString, Category: "postgres", Scope: "admin", Description: "Owner-capable PostgreSQL DuckLake catalog initialization URL; never used by serving.", Example: SecretPlaceholder, Secret: true, Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_POSTGRES_DUCKLAKE_MIGRATOR_ROLE", Field: "PostgresDuckLakeMigratorRole", Type: TypeString, Default: "leapview_ducklake_migrator", Category: "postgres", Scope: "admin", Description: "Canonical role expected by the bounded DuckLake catalog initialization connection; other role names are rejected by foundation validation.", Example: "leapview_ducklake_migrator", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_POSTGRES_DUCKLAKE_MAINTENANCE_ROLE", Field: "PostgresDuckLakeMaintenanceRole", Type: TypeString, Default: "leapview_ducklake_maintenance", Category: "postgres", Scope: "admin", Description: "Canonical least-privilege role granted bounded DuckLake metadata maintenance access; other role names are rejected by foundation validation.", Example: "leapview_ducklake_maintenance", Runtime: true, Lifecycle: "supported", Commented: true},
	...
	{Name: "LEAPVIEW_POSTGRES_CONTROL_RUNTIME_ROLE", Field: "PostgresControlRuntimeRole", Type: TypeString, Default: "leapview_control_runtime", Category: "postgres", Scope: "serve", Description: "Canonical PostgreSQL runtime role expected by the control-plane pool; other role names are rejected by foundation validation.", Example: "leapview_control_runtime", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_POSTGRES_CONTROL_INTENT", Field: "PostgresControlIntent", Type: TypeString, Default: "read-write", Category: "postgres", Scope: "serve", Description: "Read-write intent for the control-plane PostgreSQL pool; the foundation does not support read-only control access.", Example: "read-write", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_POSTGRES_DUCKLAKE_RUNTIME_ROLE", Field: "PostgresDuckLakeRuntimeRole", Type: TypeString, Default: "leapview_ducklake_runtime", Category: "postgres", Scope: "admin", Description: "Canonical role granted bounded DuckLake catalog metadata access; no DuckLake runtime pool is opened in the foundation.", Example: "leapview_ducklake_runtime", Runtime: true, Lifecycle: "supported", Commented: true},
	...
	{Name: "LEAPVIEW_POSTGRES_DUCKLAKE_ACQUIRE_TIMEOUT", Field: "PostgresDuckLakeAcquireTimeout", Type: TypeDuration, Default: "5s", Category: "postgres", Scope: "admin", Description: "Maximum time to wait when acquiring the DuckLake catalog initialization connection.", Example: "5s", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_POSTGRES_DUCKLAKE_STATEMENT_TIMEOUT", Field: "PostgresDuckLakeStatementTimeout", Type: TypeDuration, Default: "30s", Category: "postgres", Scope: "admin", Description: "DuckLake catalog initialization PostgreSQL session statement timeout.", Example: "30s", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_POSTGRES_DUCKLAKE_LOCK_TIMEOUT", Field: "PostgresDuckLakeLockTimeout", Type: TypeDuration, Default: "5s", Category: "postgres", Scope: "admin", Description: "DuckLake catalog initialization PostgreSQL session lock-wait timeout.", Example: "5s", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_POSTGRES_DUCKLAKE_IDLE_TX_TIMEOUT", Field: "PostgresDuckLakeIdleTransactionTimeout", Type: TypeDuration, Default: "1m", Category: "postgres", Scope: "admin", Description: "DuckLake catalog initialization PostgreSQL idle-in-transaction timeout.", Example: "1m", Runtime: true, Lifecycle: "supported", Commented: true},
	...
	{Name: "LEAPVIEW_RECOVERY_QUALIFICATION_ENABLED", Field: "RecoveryQualificationEnabled", Type: TypeBool, Default: "false", Category: "recovery", Scope: "serve", Description: "Run scheduled owner-qualified backup, restore, upgrade, and rollback journeys and retain their evidence.", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_RECOVERY_QUALIFICATION_EXECUTION_ENVIRONMENT", Field: "RecoveryQualificationExecutionEnvironment", Type: TypeString, Default: "host", Category: "recovery", Scope: "serve", Description: "Supported execution owner for scheduled recovery qualification; released Compose deployments use the host controller.", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_RECOVERY_QUALIFICATION_CONTROLLER", Field: "RecoveryQualificationController", Type: TypeString, Default: "/app/leapviewctl", Category: "recovery", Scope: "serve", Description: "Absolute path to the release controller used for isolated scheduled transition qualification.", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_RECOVERY_QUALIFICATION_BUNDLE", Field: "RecoveryQualificationBundle", Type: TypeString, Default: "/app/release", Category: "recovery", Scope: "serve", Description: "Absolute path to the admitted immutable release bundle consumed by transition qualification.", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_RECOVERY_QUALIFICATION_WORK_DIR", Field: "RecoveryQualificationWorkDir", Type: TypeString, Category: "recovery", Scope: "serve", Description: "Private staging root outside LEAPVIEW_HOME for scheduled backup and transition qualification.", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_RECOVERY_QUALIFICATION_CRON", Field: "RecoveryQualificationCron", Type: TypeString, Default: "0 3 * * *", Category: "recovery", Scope: "serve", Description: "Cron schedule for each production recovery qualification owner.", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_RECOVERY_QUALIFICATION_EXTERNAL_RECOVERY_POINTS", Field: "RecoveryQualificationExternalRecoveryPoints", Type: TypeString, Category: "recovery", Scope: "serve", Description: "Absolute path to the canonical FAI-515 external recovery-points JSON used by scheduled S3 qualification.", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_RECOVERY_QUALIFICATION_EXTERNAL_EVIDENCE", Field: "RecoveryQualificationExternalEvidence", Type: TypeString, Category: "recovery", Scope: "serve", Description: "Absolute path to the canonical FAI-515 external-evidence JSON used by scheduled S3 restore qualification.", Runtime: true, Lifecycle: "supported", Commented: true},
...
var rules = []Rule{
	...
	{ID: "postgres-control-intent", Description: "The control-plane PostgreSQL authority is read-write in the foundation.", When: Present("LEAPVIEW_POSTGRES_CONTROL_INTENT"), Assert: postgresControlIntent, Message: "LEAPVIEW_POSTGRES_CONTROL_INTENT must be read-write; the foundation does not support read-only control access"},
	{ID: "postgres-control-migrator-role", Description: "The control-plane migration role is canonical in the foundation.", When: Present("LEAPVIEW_POSTGRES_CONTROL_MIGRATOR_ROLE"), Assert: OneOf("LEAPVIEW_POSTGRES_CONTROL_MIGRATOR_ROLE", "leapview_control_migrator"), Message: "LEAPVIEW_POSTGRES_CONTROL_MIGRATOR_ROLE must be leapview_control_migrator; custom PostgreSQL role names are not supported by the foundation"},
	{ID: "postgres-control-runtime-role", Description: "The control-plane runtime role is canonical in the foundation.", When: Present("LEAPVIEW_POSTGRES_CONTROL_RUNTIME_ROLE"), Assert: OneOf("LEAPVIEW_POSTGRES_CONTROL_RUNTIME_ROLE", "leapview_control_runtime"), Message: "LEAPVIEW_POSTGRES_CONTROL_RUNTIME_ROLE must be leapview_control_runtime; custom PostgreSQL role names are not supported by the foundation"},
	{ID: "postgres-ducklake-migrator-role", Description: "The DuckLake catalog migration role is canonical in the foundation.", When: Present("LEAPVIEW_POSTGRES_DUCKLAKE_MIGRATOR_ROLE"), Assert: OneOf("LEAPVIEW_POSTGRES_DUCKLAKE_MIGRATOR_ROLE", "leapview_ducklake_migrator"), Message: "LEAPVIEW_POSTGRES_DUCKLAKE_MIGRATOR_ROLE must be leapview_ducklake_migrator; custom PostgreSQL role names are not supported by the foundation"},
	{ID: "postgres-ducklake-runtime-role", Description: "The DuckLake catalog runtime role is canonical in the foundation.", When: Present("LEAPVIEW_POSTGRES_DUCKLAKE_RUNTIME_ROLE"), Assert: OneOf("LEAPVIEW_POSTGRES_DUCKLAKE_RUNTIME_ROLE", "leapview_ducklake_runtime"), Message: "LEAPVIEW_POSTGRES_DUCKLAKE_RUNTIME_ROLE must be leapview_ducklake_runtime; custom PostgreSQL role names are not supported by the foundation"},
	{ID: "postgres-ducklake-maintenance-role", Description: "The DuckLake catalog maintenance role is canonical in the foundation.", When: Present("LEAPVIEW_POSTGRES_DUCKLAKE_MAINTENANCE_ROLE"), Assert: OneOf("LEAPVIEW_POSTGRES_DUCKLAKE_MAINTENANCE_ROLE", "leapview_ducklake_maintenance"), Message: "LEAPVIEW_POSTGRES_DUCKLAKE_MAINTENANCE_ROLE must be leapview_ducklake_maintenance; custom PostgreSQL role names are not supported by the foundation"},
}
