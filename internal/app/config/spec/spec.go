...
var settings = []Setting{
	...
	{Name: "LEAPVIEW_DEV_PROJECT", Type: TypeString, Default: "dashboards", Category: "development", Scope: "dev server", Description: "Analytics source root published by the managed development server.", Lifecycle: "development"},
	...
	{Name: "LEAPVIEW_POSTGRES_CONTROL_MIGRATOR_URL", Field: "PostgresControlMigratorURL", Type: TypeString, Category: "postgres", Scope: "admin", Description: "Explicit PostgreSQL control-plane migration connection URL; used only by schema and instance bootstrap authorities.", Example: SecretPlaceholder, Secret: true, Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_POSTGRES_CONTROL_MIGRATOR_ROLE", Field: "PostgresControlMigratorRole", Type: TypeString, Default: "leapview_control_migrator", Category: "postgres", Scope: "admin", Description: "PostgreSQL role used by the one-connection control-plane migration authority.", Example: "leapview_control_migrator", Runtime: true, Lifecycle: "supported", Commented: true},
