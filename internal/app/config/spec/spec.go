...
var settings = []Setting{
	...
	{Name: "LEAPVIEW_POSTGRES_DUCKLAKE_MIGRATOR_ROLE", Field: "PostgresDuckLakeMigratorRole", Type: TypeString, Default: "leapview_ducklake_migrator", Category: "postgres", Scope: "admin", Description: "Role expected by the bounded DuckLake catalog initialization connection.", Example: "leapview_ducklake_migrator", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_POSTGRES_DUCKLAKE_MAINTENANCE_ROLE", Field: "PostgresDuckLakeMaintenanceRole", Type: TypeString, Default: "leapview_ducklake_maintenance", Category: "postgres", Scope: "admin", Description: "Least-privilege role granted bounded DuckLake metadata maintenance access.", Example: "leapview_ducklake_maintenance", Runtime: true, Lifecycle: "supported", Commented: true},
