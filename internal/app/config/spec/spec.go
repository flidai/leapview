...
var settings = []Setting{
	...
	{Name: "LEAPVIEW_DUCKDB_EXTENSION_SUPPLY_PATH", Field: "DuckDBExtensionSupplyPath", Type: TypeString, Category: "storage", Scope: "serve", Description: "Absolute path to the target-reviewed DuckDB extension supply document.", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_DUCKDB_EXTENSION_SUPPLY_SHA256", Field: "DuckDBExtensionSupplySHA256", Type: TypeString, Category: "storage", Scope: "serve", Description: "Lowercase SHA-256 digest anchoring the extension supply document.", Runtime: true, Lifecycle: "supported", Commented: true},
