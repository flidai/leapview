...
var settings = []Setting{
	...
	{Name: "LEAPVIEW_AGENT_MODEL", Field: "AgentModel", Type: TypeString, Category: "agent", Scope: "serve", Description: "Agent model identifier.", Example: "gpt-6-luna", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_AGENT_REASONING_EFFORT", Field: "AgentReasoningEffort", Type: TypeString, Default: "high", Category: "agent", Scope: "serve", Description: "Reasoning effort sent to supported agent models.", Example: "high", Runtime: true, Lifecycle: "supported", Commented: true},
