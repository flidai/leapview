...
var settings = []Setting{
	...
	{Name: "LEAPVIEW_REQUIRE_PLATFORM_ROLE_APPROVAL", Field: "RequirePlatformRoleApproval", Type: TypeBool, Category: "security", Scope: "serve", Description: "Require a durable second administrator approval before platform-role grants and revocations.", Default: "false", Runtime: true, Lifecycle: "supported", Commented: true},
