...
var settings = []Setting{
	...
	{Name: "LEAPVIEW_WORKLOAD_BACKGROUND_MAX_QUEUED_PER_WORKSPACE", Field: "WorkloadBackgroundMaxQueuedPerWorkspace", Type: TypeInt, Default: "4", Category: "workload", Scope: "serve", Description: "Maximum queued background operations for one workspace.", Runtime: true, Lifecycle: "supported", Commented: true},
	...
	{Name: "LEAPVIEW_WORKLOAD_REFRESH_MAX_QUEUED_PER_WORKSPACE", Field: "WorkloadRefreshMaxQueuedPerWorkspace", Type: TypeInt, Default: "1", Category: "workload", Scope: "serve", Description: "Maximum queued refresh operations for one workspace.", Runtime: true, Lifecycle: "supported", Commented: true},
	...
	{Name: "LEAPVIEW_WORKLOAD_CONTROL_MAX_QUEUED_PER_WORKSPACE", Field: "WorkloadControlMaxQueuedPerWorkspace", Type: TypeInt, Default: "16", Category: "workload", Scope: "serve", Description: "Maximum queued node-scoped control operations.", Runtime: true, Lifecycle: "supported", Commented: true},
	...
	{Name: "LEAPVIEW_WORKLOAD_MAINTENANCE_MAX_QUEUED_PER_WORKSPACE", Field: "WorkloadMaintenanceMaxQueuedPerWorkspace", Type: TypeInt, Default: "0", Category: "workload", Scope: "serve", Description: "Maximum queued node-scoped maintenance operations.", Runtime: true, Lifecycle: "supported", Commented: true},
	...
	{Name: "LEAPVIEW_QUERY_CACHE_WORKSPACE_MAX_ENTRIES", Field: "QueryCacheWorkspaceMaxEntries", Type: TypeInt, Default: "512", Category: "analytics", Scope: "serve", Description: "Maximum cached result entries retained across one workspace's serving generations.", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_QUERY_CACHE_WORKSPACE_MAX_BYTES", Field: "QueryCacheWorkspaceMaxBytes", Type: TypeInt64, Default: "134217728", Category: "analytics", Scope: "serve", Description: "Maximum conservatively retained Arrow cache bytes across one workspace's serving generations.", Runtime: true, Lifecycle: "supported", Commented: true},
