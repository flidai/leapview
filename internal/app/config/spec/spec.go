...
var settings = []Setting{
	...
	{Name: "LEAPVIEW_QUALIFICATION_MANUAL_PREREQUISITES", Type: TypeBool, Category: "ci", Scope: "authoring package qualification", Description: "Confirm that required human browser authentication prerequisites are available.", Default: "false", Lifecycle: "internal"},
