...
var settings = []Setting{
	...
	{Name: "LEAPVIEW_AGENT_MODEL", Field: "AgentModel", Type: TypeString, Category: "agent", Scope: "serve", Description: "Deployment-selected agent model identifier.", Runtime: true, Lifecycle: "supported", Commented: true},
	{Name: "LEAPVIEW_AGENT_REASONING_EFFORT", Field: "AgentReasoningEffort", Type: TypeString, Category: "agent", Scope: "serve", Description: "Optional deployment-selected reasoning effort sent to supported agent models.", Runtime: true, Lifecycle: "supported", Commented: true},
