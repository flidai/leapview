...
func postgresOnboardingConfig(t *testing.T, h *postgrestest.Harness, control, catalog *postgrestest.Database, roles postgresOnboardingRoles, fixture extensionfixture.Fixture) config.Config {
	...
	return config.Config{
		...
		PostgresControlURL:                    tlsURL(control.PrivateURL(roles.controlRuntime)),
		PostgresControlMigratorURL:            tlsURL(control.PrivateURL(roles.controlMigrator)),
		PostgresControlMaintenanceURL:         tlsURL(control.PrivateURL(roles.controlMaintenance)),
		PostgresControlReadonlyURL:            tlsURL(control.PrivateURL(roles.controlReadonly)),
		PostgresControlUpgradeCoordinatorURL:  tlsURL(control.PrivateURL(roles.controlUpgrade)),
		PostgresDuckLakeURL:                   tlsURL(catalog.PrivateURL(roles.catalogRuntime)),
		PostgresDuckLakeMigratorURL:           tlsURL(catalog.PrivateURL(roles.catalogMigrator)),
		PostgresDuckLakeMaintenanceURL:        tlsURL(catalog.PrivateURL(roles.catalogMaintenance)),
