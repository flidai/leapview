...
// the native PostgreSQL control-plane authority. All other administrative
// operations remain delegated to the legacy offline implementation until
// their native owners are available.
...
// only Maintenance. This keeps non-production behavior byte-for-byte on the
// legacy path while production maintenance is PostgreSQL-native.
