...
const (
	defaultSource = "internal/app/tools/duckdbsqldocsgen/upstream/extension/core_functions"
	defaultLock   = "internal/app/tools/duckdbsqldocsgen/upstream.lock.json"
...
func render(input documentationInput) (string, error) {
	...
	b.WriteString("// Code generated by internal/app/tools/duckdbsqldocsgen; DO NOT EDIT.\n")
