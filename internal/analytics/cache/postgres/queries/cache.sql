...
SELECT cache.ensure_namespace(sqlc.arg(namespace_key), sqlc.arg(partition_kind), sqlc.arg(project_id), sqlc.arg(environment), sqlc.narg(candidate_id)::text) AS epoch;
...
SELECT manifest_id, partition_kind, project_id, environment, candidate_id,
       partition_format_version, dependency_digest, policy_fingerprint,
       canonical_query_digest, key_format_version, storage_security_domain,
...
SELECT i.invalidation_id, i.event_id, i.namespace_key,
       e.partition_kind, e.project_id, e.environment, e.candidate_id,
...
SELECT cache.admit_manifest(sqlc.arg(manifest_id)::uuid, sqlc.arg(lease_id)::uuid, sqlc.arg(cache_key), sqlc.arg(owner_id), sqlc.arg(fencing_epoch), sqlc.arg(namespace_key), sqlc.arg(namespace_epoch), sqlc.arg(partition_kind), sqlc.arg(project_id), sqlc.arg(environment), sqlc.narg(candidate_id)::text, sqlc.arg(partition_format_version), sqlc.arg(dependency_digest), sqlc.arg(policy_fingerprint), sqlc.arg(canonical_query_digest), sqlc.arg(key_format_version), sqlc.arg(storage_security_domain), sqlc.arg(object_digest), sqlc.arg(object_key), sqlc.arg(byte_size), sqlc.arg(metadata)::jsonb, sqlc.narg(expires_at)::timestamptz) AS manifest_id;
