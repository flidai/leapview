...
test('semantic model overview separates summary metadata from model inspection', async () => {
  ...
  try {
    ...
    expect(state.contentRules).toEqual({ afterOverview: '0px', beforeContents: '1px', beforeImpact: '0px' })
    ...
    expect(state.overviewLayout.summaryBorders).toEqual(['1px', '1px', '1px', '1px'])
