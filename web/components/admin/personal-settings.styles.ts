...
export const personalSettingsStyles = css`
    ...
    .security-session-table td { min-width: 0; padding: var(--base-size-10, 10px) var(--base-size-12); border-top: var(--lv-border-muted); color: var(--lv-fg-default); vertical-align: middle; }
    .security-session-table time, .security-session-access { color: var(--lv-fg-muted); font: var(--lv-type-body-compact); }
    .security-session-device { display: grid; width: 100%; min-width: 0; min-height: var(--base-size-40); grid-template-columns: var(--base-size-32) minmax(0, 1fr); align-items: center; gap: var(--base-size-10, 10px); border-color: transparent; background: transparent; padding: 0; text-align: left; }
