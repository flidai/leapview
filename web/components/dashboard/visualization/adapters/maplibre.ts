...
export const mapValueRangeTargetCSS = '.lv-map-range-track{--lv-map-range-target:max(24px,calc(24px * var(--report-canvas-inverse-scale,1)));height:var(--lv-map-range-target)}.lv-map-range-rail,.lv-map-range-fill{top:50%;transform:translateY(-50%)}.lv-map-range-input{height:var(--lv-map-range-target)}'
...
export class MapLibreHandle implements RendererHandle {
  ...
  constructor(private readonly container: HTMLElement, private readonly frame: HTMLElement, private readonly map: MapLibreMap, private readonly attribution: HTMLElement, private context: RendererContext) {
    ...
    this.legendStyle.textContent += mapValueRangeTargetCSS
