...
.maplibregl-ctrl-group button{position:relative;display:block;width:30px;height:30px;margin:0;padding:0;border:0;border-bottom:1px solid var(--lv-line-subtle,#d8dee4);outline:none;background:transparent;color:var(--lv-fg-default,#1f2328);font-family:var(--fontStack-system);font-size:var(--text-subtitle-size);font-weight:var(--base-text-weight-semibold);line-height:30px;cursor:pointer}
